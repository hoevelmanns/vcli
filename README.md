...
@hoevelmanns/vcli/1.3.28 linux-x64 node-v12.13.1
$ vc --help [COMMAND]
USAGE
  $ vc COMMAND
...
...
_See code: [src/commands/create.ts](https://github.com/hoevelmanns/vcli/blob/v1.3.28/src/commands/create.ts)_
...
_See code: [src/commands/refresh.ts](https://github.com/hoevelmanns/vcli/blob/v1.3.28/src/commands/refresh.ts)_
...
_See code: [src/commands/search.ts](https://github.com/hoevelmanns/vcli/blob/v1.3.28/src/commands/search.ts)_
...
_See code: [src/commands/vm.ts](https://github.com/hoevelmanns/vcli/blob/v1.3.28/src/commands/vm.ts)_
...
_See code: [src/commands/workspace.ts](https://github.com/hoevelmanns/vcli/blob/v1.3.28/src/commands/workspace.ts)_
<!-- commandsstop -->
