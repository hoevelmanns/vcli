...
vcli/1.0.4-poc linux-x64 node-v12.13.1
$ vc --help [COMMAND]
USAGE
  $ vc COMMAND
...
...
_See code: [src/commands/build.ts](https://github.com/hoevelmanns/vcli/blob/v1.0.4-poc/src/commands/build.ts)_
...
_See code: [src/commands/create.ts](https://github.com/hoevelmanns/vcli/blob/v1.0.4-poc/src/commands/create.ts)_
...
_See code: [src/commands/halt.ts](https://github.com/hoevelmanns/vcli/blob/v1.0.4-poc/src/commands/halt.ts)_
...
_See code: [src/commands/refresh.ts](https://github.com/hoevelmanns/vcli/blob/v1.0.4-poc/src/commands/refresh.ts)_
...
_See code: [src/commands/up.ts](https://github.com/hoevelmanns/vcli/blob/v1.0.4-poc/src/commands/up.ts)_
<!-- commandsstop -->
