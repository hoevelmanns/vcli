...
@hoevelmanns/vcli/1.2.61 linux-x64 node-v12.13.1
$ vc --help [COMMAND]
USAGE
  $ vc COMMAND
...
...
_See code: [src/commands/create.ts](https://github.com/hoevelmanns/vcli/blob/v1.2.61/src/commands/create.ts)_
...
_See code: [src/commands/halt.ts](https://github.com/hoevelmanns/vcli/blob/v1.2.61/src/commands/halt.ts)_
...
_See code: [src/commands/refresh.ts](https://github.com/hoevelmanns/vcli/blob/v1.2.61/src/commands/refresh.ts)_
...
_See code: [src/commands/up.ts](https://github.com/hoevelmanns/vcli/blob/v1.2.61/src/commands/up.ts)_
...
_See code: [src/commands/vagrant.ts](https://github.com/hoevelmanns/vcli/blob/v1.2.61/src/commands/vagrant.ts)_
<!-- commandsstop -->
